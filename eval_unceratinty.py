...
def mcdrop_subset(args):
    ...
    raw_dd_test = get_dd_corpus("subset")
    test_dataset = RankerDataset(raw_dd_test, tokenizer, "subset", 128, UTTR_TOKEN)
    softmax = torch.nn.Softmax(dim=1)
    ...
    print("f1: {}".format(f1))
    # print("ECE: {}".format(calibration_error))
    print("Uncertainty: {}".format(uncertainty_list))
